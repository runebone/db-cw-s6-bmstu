...
\hline
    ...
    % GET & /api/v1/register & Получение страницы для регистрации \\ \hline
    POST & /api/v1/register & Регистрация пользователя с введенными именем пользователя, адресом почты и паролем \\ \hline
    % GET & /api/v1/login & Получение страницы для входа в систему \\ \hline
    POST & /api/v1/login & Вход в систему по имени пользователя и паролю \\ \hline
    % GET & /api/v1/profile & Получение личной страницы пользователя \\ \hline
